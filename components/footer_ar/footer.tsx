        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-sm text-gray-300 text-center md:text-right">
              نحن مجموعة من أبناء شمال لبنان، تربويّون، رجال أعمال، وعاملون في مختلف المجالات، جمعتنا رغبة صادقة في تغيير واقعنا ومجتمعاتنا.
            </p>
          </div>

          {/* Column 2: Our Programs */}
          <div className="hidden md:block flex flex-col items-center md:items-start">
            <h3 className="text-lg font-bold mb-4 uppercase">برامجنا</h3>
          ...
          <div className="flex flex-col items-center md:items-start">
            <h3 className="text-lg font-bold mb-4 uppercase">حول الوقف</h3>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/about"
          ...
          <div className="flex flex-col items-center md:items-start">
            <h3 className="text-lg font-bold mb-4 uppercase">اتصل بنا</h3>
            <p className="mb-4">
              <a
            ...
            <h3 className="text-lg font-bold mb-2 uppercase">تابعونا</h3>
