    ...
    >
      ...
      <div className="relative z-10 text-white text-center p-8">
        ...
        <div className="mt-6 mx-auto max-w-[640px] text-justify lg:text-center md:text-lg xl:text-xl">
          نحن مجموعة من أبناء شمال لبنان، 
        ...
        <div className="flex flex-col md:flex-row gap-14 text-white mt-16 text-left px-6 md:px-10 ">
          <div className="flex-1">
            ...
            <p className="text-justify lg:text-center md:text-lg xl:text-xl max-w-lg mx-auto">
              نحن نعمل معًا من خلال التطوع وبناء المؤسسات لجعل شمال لبنان - 
        ...
        <div className="mt-6 mx-auto max-w-[640px] text-justify lg:text-center md:text-lg xl:text-xl">
            <div className="text-justify">
                ...
                فتحقق بذلك وصية الرسول ﷺ  حيث قال "فأعْلِمْهُمْ أنَّ اللَّهَ افْتَرَضَ 
                عليهم صَدَقَةً تُؤْخَذُ مِن أغْنِيائِهِمْ فَتُرَدُّ في فُقَرائِهِمْ" رواه مسلم
                <br /><br />

                ويكون أمر الله تعالى "وَتَعَاوَنُوا عَلَى 
                الْبِرِّ وَالتَّقْوَىٰ" سبباً في استكمال عناصر القوة والانتقال 
