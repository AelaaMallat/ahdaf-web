    ...
    <div dir="rtl" className="min-h-screen flex items-center justify-center bg-gray-100 pt-20 pb-4">
      <div className="w-full max-w-6xl p-8 m-2 bg-white rounded-xl shadow-lg">
        ...
        <p className="text-center text-gray-700 max-w-4xl mx-auto mb-12">
          يتكون تحت قيادة الرئيس التنفيذي السيد محمد مطرجي، يضطلع مجلس الإدارة في
           وقف أهداف الخيري بدور محوري في ضمان التطبيق الفعّال للسياسات التي
           يعتمدها مجلس الأمناء. ويتألف المجلس من مدراء الأقسام في المؤسسة،
           الذين يعملون بتنسيق وتعاون لدعم جهود فريق العمل والمتطوعين.
           ويتيح هذا الهيكل التنظيمي اعتماد نهج استراتيجي متكامل في
           أعمالنا الخيرية، بما ينسجم مع الرؤية والرسالة التي وضعها مجلس الأمناء.
        </p>
