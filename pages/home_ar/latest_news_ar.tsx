    ...
    >
      ...
      <div className="overflow-x-hidden">
        <div className="p-8 pt-48 md:px-28 right-0 max-w-xl bg-white/80">
          ...
          <p className="text-[#041231] mt-2 text-justify">
            افتُتح اللقاء بتلاوة عطرة من القرآن الكريم وتلتها كلمة ألقاها الشيخ محمد مطرجي المدير التنفيذي لوقف أهداف الخيري الذي أكد فيها على أهمية تظافر الجهود لخدمة المجتمع.
          </p>
